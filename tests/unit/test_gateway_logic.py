...
def test_high_value_loan_tiering():
    ...
    subject = resource_governer.determin_route(loan_amount=1500000.0, user_tier="enterprise")
    assert subject == "quantum.qpu.high_priority"

def test_standard_loan_tiering():
    resource_governer = ResourceGovernor()
    # Small loans should stay on simulators
    subject = resource_governer.determin_route(loan_amount=50000, user_tier="standard")
...
def test_precision_loan_tiering():
    ...
    subject = resource_governer.determin_route(loan_amount=150000, user_tier="pro")
