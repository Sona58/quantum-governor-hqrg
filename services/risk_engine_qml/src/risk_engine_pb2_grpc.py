...
class RiskAnalysisStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyzeRisk = channel.unary_unary(
                '/riskengine.RiskAnalysis/AnalyzeRisk',
...
class RiskAnalysisServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_RiskAnalysisServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'riskengine.RiskAnalysis', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('riskengine.RiskAnalysis', rpc_method_handlers)
